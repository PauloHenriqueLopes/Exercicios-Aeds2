...
class Celula {
    ...
    Celula(Pokemon pokemon) {
		this.pokemon = pokemon;
		this.prox = null;
	}

    Celula(Pokemon pokemon, Celula prox) {
		this.pokemon = pokemon;
		this.prox = prox;
	}
}
...
class Lista {
    ...
    public boolean pesquisar(String name) {
		...
		for (Celula i = primeiro.prox; i != null; i = i.prox) {
            if(i.pokemon.getName().equals(name)){
                retorno = true;
                i = ultimo;
            }
		}
...
class Hash {
    ...
    public Hash(int tamanho) {
        ...
        this.tabela = new Lista[this.tamanho];
    }
    ...
    public int hash(String name) {
        ...
        return asciiSum % tamanho;
    }

    public boolean pesquisar(String name) {
        int pos = hash(name);
        return tabela[pos].pesquisar(name);
    }

    public void inserirInicio(Pokemon pokemon) {
       int pos  = hash(pokemon.getName());
       tabela[pos].inserirInicio(pokemon);
    }
